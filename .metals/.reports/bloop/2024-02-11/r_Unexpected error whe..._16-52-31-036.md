error id: bwve6r/hSsqWv1UDMpffNQ==
### Bloop error:
...
parent      =  extends Json2Codec[Int] {
  def encode(value: Int) = null
} # -1,
parent span = <4659..4708>,
child       = def encode(value: Int) = null # -1,
child span  = [4684..4688..5754]
