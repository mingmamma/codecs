...
parent      = [A =  : Json2Codec] extends Tuple1[A] {
  def encode(value: Tuple1[ACURSOR]) = null
} # -1,
parent span = <7452..7521>,
child       = def encode(value: Tuple1[ACURSOR]) = null # -1,
child span  = [7487..7491..8381]
