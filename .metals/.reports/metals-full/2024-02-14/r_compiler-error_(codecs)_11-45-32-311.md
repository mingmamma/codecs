...
parent      = [A =  : Json2Codec, B =  : Json2Codec] extends Json2Codec[Tuple2[A, B]] {
  def encode(value: Tuple2[A, B]): Json =
    Tuple2(summon[Json2Codec[A]].encode(value._2), null)
} # -1,
parent span = <7681..8715>,
child       = def encode(value: Tuple2[A, B]): Json =
  Tuple2(summon[Json2Codec[A]].encode(value._2), null) # -1,
child span  = [7746..7750..8999]
...
object Json2Codecs:
  ...
  given Tuple2Codec[A: Json2Codec, B: Json2Codec]: Json2Codec[Tuple2[A, B]] with
    def encode(value: Tuple2[A, B]): Json = Tuple2(summon[Json2Codec[A]].encode(value._2),
