...
parent      = [A =  : Json2Codec] extends Tuple1[A] {
  ...
  def decode(json: Json2): Tuple1[A] = null
} # -1,
parent span = <7452..7604>,
child       = def decode(json: Json2): Tuple1[A] = null # -1,
child span  = [7568..7572..8467]
...
object Json2Codecs:
  ...
  given Tuple1Codec[A: Json2Codec]: Tuple1[A] with
    def encode(value: Tuple1[A]): Json2 = summon[Json2Codec[A]].encode(value._1)
    def decode(json: Json2): Tuple1[A] =
