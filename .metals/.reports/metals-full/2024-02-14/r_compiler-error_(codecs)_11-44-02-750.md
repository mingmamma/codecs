...
parent      = [A =  : Json2Codec, B =  : Json2Codec] extends Json2Codec[Tuple2[A, B]] {
  def encode(value: Tuple2[ACURSOR]) = null
} # -1,
parent span = <7681..7780>,
child       = def encode(value: Tuple2[ACURSOR]) = null # -1,
child span  = [7746..7750..8640]
