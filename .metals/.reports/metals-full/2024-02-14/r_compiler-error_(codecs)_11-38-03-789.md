...
parent      = [A =  : Json2Codec] extends Tuple1[A] {
  def encode(value: Tuple1[A]): Json2 = summon[Json2Codec] value null
} # -1,
parent span = <7452..7551>,
child       = def encode(value: Tuple1[A]): Json2 = summon[Json2Codec] value null # -1,
child span  = [7487..7491..8411]
