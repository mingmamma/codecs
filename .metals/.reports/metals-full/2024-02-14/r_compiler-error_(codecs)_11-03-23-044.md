...
parent      = [A =  : Json2Codec] extends Json2Codec[Option[A]] {
  def encode(value: Option[A]): Json2 = value mCURSOR null
} # -1,
parent span = <7091..7196>,
child       = def encode(value: Option[A]): Json2 = value mCURSOR null # -1,
child span  = [7138..7142..8056]
