...
parent      = [A =  : Json2Codec, B =  : Json2Codec] extends Json2Codec[Tuple2[A, B]] {
  ...
  def decode(json: Json2): Tuple2[A, B] = json mathc null
} # -1,
parent span = <7681..7965>,
child       = def decode(json: Json2): Tuple2[A, B] = json mathc null # -1,
child span  = [7909..7913..8826]
