...
parent      = [A =  : Json2Codec] extends Tuple1[A] {
  def encode(value: Tuple1[A]): Json2 = summon[<error>] value null
} # -1,
parent span = <7452..7541>,
child       = def encode(value: Tuple1[A]): Json2 = summon[<error>] value null # -1,
child span  = [7487..7491..8401]
...
object Json2Codecs:
  ...
  given Tuple1Codec[A: Json2Codec]: Tuple1[A] with
    def encode(value: Tuple1[A]): Json2 = summon[]@@value._1
