...
parent      = [A =  : Json2Codec, B =  : Json2Codec] extends Json2Codec[Tuple2[A, B]] {
  def encode(value: Tuple2[A, BCURSOR]) = null
} # -1,
parent span = <7681..7783>,
child       = def encode(value: Tuple2[A, BCURSOR]) = null # -1,
child span  = [7746..7750..8643]
