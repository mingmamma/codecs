...
parent      = [K =  : Json2Codcs, V =  : Json2Codec] extends Json2Codec[Map[K, V]] {
  def encode(value: Map[K, VCURSOR]) = null
} # -1,
parent span = <7087..7183>,
child       = def encode(value: Map[K, VCURSOR]) = null # -1,
child span  = [7149..7153..7187]
...
object Json2Codecs:
  ...
  given MapCodec[K: Json2Codcs, V: Json2Codec]: Json2Codec[Map[K, V]] with
    def encode(value: Map[K, V@@])
