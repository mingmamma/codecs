...
parent      = [A](using protected given val codec: Json2Codec[A]) extends Json2Codec[Vector[A]
  ] {
  def encode(value: Vector[A]): Json2 = null
} # -1,
parent span = <5594..5698>,
child       = def encode(value: Vector[A]): Json2 = null # -1,
child span  = [5657..5661..6750]
...
Scala version: 3.3.0
Classpath:
<WORKSPACE>/.bloop/codecs/bloop-bsp-clients-classes/classes-Metals-rYIzqZ7YRbKAY3AHXzJDRQ== [exists ], <HOME>/Library/Caches/bloop/semanticdb/com.sourcegraph.semanticdb-javac.0.9.9/semanticdb-javac-0.9.9.jar [exists ], <HOME>/Library/Caches/Coursier/v1/https/repo1.maven.org/maven2/org/scala-lang/scala3-library_3/3.3.0/scala3-library_3-3.3.0.jar [exists ], <HOME>/Library/Caches/Coursier/v1/https/repo1.maven.org/maven2/org/typelevel/jawn-parser_3/1.1.2/jawn-parser_3-1.1.2.jar [exists ], <HOME>/Library/Caches/Coursier/v1/https/repo1.maven.org/maven2/org/scala-lang/scala-library/2.13.10/scala-library-2.13.10.jar [exists ]
Options:
...
// trait primitiveCodes:
  ...
  given VectorCodec[A](using codec: Json2Codec[A]): Json2Codec[Vector[A]] with
    def encode(value: Vector[A]): Json2 = val
