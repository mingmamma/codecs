...
parent      = [A](using protected given val codecA: Json2Codec[A]) extends Json2Codec[
  ...
  def decode(json: Json2): Vector[A] = json mCURSOR null
} # -1,
parent span = <5594..5811>,
child       = def decode(json: Json2): Vector[A] = json mCURSOR null # -1,
child span  = [5755..5759..6863]
