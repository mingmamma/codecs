...
parent      = [A =  : Json2Codec] extends Json2Codec[List[A]] {
  def encode(value: Array[A]): Json2 = null
} # -1,
parent span = <6388..6471>,
child       = def encode(value: Array[A]): Json2 = null # -1,
child span  = [6435..6439..7395]
...
// trait primitiveCodes:
  ...
  given ListCodec[A: Json2Codec]: Json2Codec[List[A]] with
      def encode(value: Array[A]): Json2 = 
